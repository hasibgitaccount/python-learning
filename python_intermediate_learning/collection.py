...
# deque
# the deque is a double ended queue and it can be used to add and remove elements from both ends. and both are implemented in a way that this will be very efficient.
from collections import deque
d = deque() # lets create a deque 

d.append(1) # now we can append items like with a list
d.append(2)
print(d)
d.appendleft(3)# it will add elements in the left
print(d)
...
d.popleft()
print(d)
# we can also clear all elements
d.clear()
print(d)
# we can also add multiple elements in right or left
d.extend([4,5,6])
print(d)
d.extendleft([7,8,9])
print(d)
# we can also rotate all elements to right a given amount of time
d.rotate(1)
print(d)
d.rotate(2)
print(d)
# if we want to rotate to left then use (-) symbol
d.rotate(-1)
print(d)
d.rotate(-2)
print(d)